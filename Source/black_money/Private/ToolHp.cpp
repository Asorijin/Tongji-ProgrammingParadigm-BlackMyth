...
AToolHp::AToolHp()
{
    ...
    // 绑定重叠事件（必须在构造函数中绑定！）
    InteractionTrigger->OnComponentBeginOverlap.AddUniqueDynamic(this, &AToolHp::OnOverlapBegin);
    InteractionTrigger->OnComponentEndOverlap.AddUniqueDynamic(this, &AToolHp::OnOverlapEnd);
...
void AToolHp::OnOverlapEnd(UPrimitiveComponent* OverlappedComp, AActor* OtherActor,
