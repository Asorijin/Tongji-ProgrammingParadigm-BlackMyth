...
struct Z_Construct_UClass_UEventCenter_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_pawnLastLocation_MetaData[] = {
		{ "ModuleRelativePath", "Public/EventCenter.h" },
	};
#endif // WITH_METADATA
	static const UECodeGen_Private::FStructPropertyParams NewProp_pawnLastLocation;
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UEventCenter_Statics::NewProp_pawnLastLocation = { "pawnLastLocation", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UEventCenter, pawnLastLocation), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_pawnLastLocation_MetaData), NewProp_pawnLastLocation_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UEventCenter_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UEventCenter_Statics::NewProp_pawnLastLocation,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UEventCenter_Statics::PropPointers) < 2048);
...
const UECodeGen_Private::FClassParams Z_Construct_UClass_UEventCenter_Statics::ClassParams = {
	...
	DependentSingletons,
	nullptr,
	Z_Construct_UClass_UEventCenter_Statics::PropPointers,
	nullptr,
	UE_ARRAY_COUNT(DependentSingletons),
	0,
	UE_ARRAY_COUNT(Z_Construct_UClass_UEventCenter_Statics::PropPointers),
	0,
	0x001000A0u,
...
struct Z_CompiledInDeferFile_FID_Tongji_ProgrammingParadigm_BlackMyth_Source_black_money_Public_EventCenter_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UEventCenter, UEventCenter::StaticClass, TEXT("UEventCenter"), &Z_Registration_Info_UClass_UEventCenter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEventCenter), 156564503U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Tongji_ProgrammingParadigm_BlackMyth_Source_black_money_Public_EventCenter_h_443560803(TEXT("/Script/black_money"),
