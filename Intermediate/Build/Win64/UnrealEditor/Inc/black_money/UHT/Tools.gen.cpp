...
struct Z_Construct_UClass_ATools_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_attributeVector_MetaData[] = {
#if !UE_BUILD_SHIPPING
		{ "Comment", "//0:hp  1:mp  2:attack  3:defence  4:speed\n" },
#endif
		{ "ModuleRelativePath", "Public/Tools.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "0:hp  1:mp  2:attack  3:defence  4:speed" },
#endif
	};
...
#endif // WITH_METADATA
	static const UECodeGen_Private::FIntPropertyParams NewProp_attributeVector_Inner;
	static const UECodeGen_Private::FArrayPropertyParams NewProp_attributeVector;
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_ATools_Statics::NewProp_attributeVector_Inner = { "attributeVector", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ATools_Statics::NewProp_attributeVector = { "attributeVector", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ATools, attributeVector), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_attributeVector_MetaData), NewProp_attributeVector_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ATools_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATools_Statics::NewProp_attributeVector_Inner,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATools_Statics::NewProp_attributeVector,
...
struct Z_CompiledInDeferFile_FID_Tongji_ProgrammingParadigm_BlackMyth_Source_black_money_Public_Tools_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ATools, ATools::StaticClass, TEXT("ATools"), &Z_Registration_Info_UClass_ATools, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATools), 51549314U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Tongji_ProgrammingParadigm_BlackMyth_Source_black_money_Public_Tools_h_1595900867(TEXT("/Script/black_money"),
